...
(function() {
  ...
  "circoncision de n.-s. j.-c.": "temporal/1/8",
  ...
  "férie de l'avent": "temporal/0/0",
  "férie de l'avent — o adonaï": "temporal/0/5",
  "férie de l'avent — o clavis david": "temporal/0/5",
  "férie de l'avent — o emmanuel": "temporal/0/5",
  "férie de l'avent — o oriens": "temporal/0/5",
  "férie de l'avent — o radix jesse": "temporal/0/5",
  "férie de l'avent — o rex gentium": "temporal/0/5",
  "férie de l'avent — o sapientia": "temporal/0/5",
  "férie — iie semaine de carême": "temporal/5/12",
  "férie — iie semaine de l'avent": "temporal/0/0",
  "férie — iiie semaine de carême": "temporal/5/19",
  "férie — iiie semaine de l'avent": "temporal/0/0",
  "férie — ire semaine de carême": "temporal/5/5",
  "férie — ire semaine de l'avent": "temporal/0/0",
  "férie — ive semaine de carême": "temporal/5/26",
  "férie — ive semaine de l'avent": "temporal/0/5",
  "férie — temps de la passion": "temporal/6/1",
  "férie — temps de la passion (sept douleurs de n.-d.)": "temporal/6/1",
  "férie — temps de la quinquagésime": "temporal/4/2",
  "férie — temps de la septuagésime": "temporal/4/0",
  "férie — temps de la sexagésime": "temporal/4/0",
  "férie — temps pascal": "temporal/7/0",
  ...
  "ier dimanche de carême": "temporal/5/4",
  "ier dimanche de l'avent": "temporal/0/0",
  "iie dimanche de carême": "temporal/5/11",
  "iie dimanche de l'avent": "temporal/0/0",
  "iiie dimanche de carême": "temporal/5/18",
  "iiie dimanche de l'avent (gaudete)": "temporal/0/0",
  "invention de s. étienne, premier martyr": "temporal/7/0",
  "invention des reliques de saint étienne": "temporal/7/0",
  "ive dimanche de carême (laetare)": "temporal/5/25",
  "ive dimanche de l'avent": "temporal/0/5",
  "jeudi après les cendres": "temporal/5/1",
  "jeudi de la 1e semaine du carême": "temporal/5/4",
  ...
  "jeudi de la 5e semaine du carême": "temporal/6/1",
  ...
  "lundi de la 1e semaine du carême": "temporal/5/4",
  "lundi de la 1re semaine du carême": "temporal/5/5",
  "lundi de la 2e semaine du carême": "temporal/5/11",
  "lundi de la 3e semaine du carême": "temporal/5/18",
  "lundi de la 4e semaine du carême": "temporal/5/25",
  "lundi de la passion": "temporal/6/1",
  "lundi de la quinquagésime": "temporal/4/2",
  "lundi de la semaine sainte": "temporal/6/7",
  "lundi de pentecôte": "temporal/8/4",
  "lundi de pâques": "temporal/7/1",
  "lundi des rogations": "temporal/8/0",
  "lundi saint": "temporal/6/8",
  "mardi de la 1e semaine du carême": "temporal/5/4",
  ...
  "mardi de la 5e semaine du carême": "temporal/6/1",
  "mardi de la passion": "temporal/6/1",
  "mardi de la quinquagésime": "temporal/4/2",
  "mardi de la quinquagésime (mardi gras)": "temporal/4/2",
  "mardi de la semaine sainte": "temporal/6/7",
  "mardi de pentecôte": "temporal/8/5",
  "mardi de pâques": "temporal/7/2",
  "mardi des rogations": "temporal/8/0",
  ...
  "mercredi de la semaine sainte": "temporal/6/7",
  "mercredi de pâques": "temporal/7/3",
  "mercredi des cendres": "temporal/5/0",
  "mercredi des quatre-temps d'automne": "temporal/9/20",
  "mercredi des quatre-temps de carême": "temporal/5/7",
  "mercredi des quatre-temps de l'avent": "temporal/0/3",
  "mercredi des quatre-temps de pentecôte": "temporal/8/6",
  "mercredi des quatre-temps de septembre": "temporal/9/22",
  "mercredi des quatre-temps du carême": "temporal/5/7",
  "mercredi des rogations": "temporal/8/0",
  "mercredi saint": "temporal/6/10",
  "nativité de n.-s. j.-c.": "temporal/1/0",
  "nativité de notre-seigneur": "temporal/1/0",
  "noël": "temporal/1/0",
  "octave de la nativité": "temporal/1/8",
  "octave de saint jean": "temporal/1/0",
  "octave des saints innocents": "temporal/1/0",
  "pentecôte": "temporal/8/3",
  "pâques": "temporal/7/0",
  "rogations — lundi": "temporal/8/0",
  "rogations — mardi": "temporal/8/0",
  "rogations — mercredi": "temporal/8/0",
  "s. anaclet, pape et martyr": "temporal/7/0",
  "s. jean avant la porte latine": "temporal/7/0",
  "s. jean, apôtre et évangéliste": "temporal/1/0",
  "s. jean-baptiste de la salle, confesseur": "temporal/7/0",
  "s. jean-françois régis, confesseur": "temporal/7/0",
  "s. justin, martyr": "temporal/7/0",
  "s. nom de jésus": "temporal/1/9",
  "s. pierre chrysologue, évêque et docteur": "temporal/7/0",
  "s. rose de viterbe, vierge": "temporal/9/0",
  "s. sylvestre ier, pape et confesseur": "temporal/1/0",
  "s. thomas becket, évêque et martyr": "temporal/1/0",
  "s. venant, martyr": "temporal/5/18",
  "s. étienne, premier martyr": "temporal/1/0",
  "sacré-cœur": "temporal/9/4",
  "saint anaclet, pape et martyr": "temporal/7/0",
  "saint jean devant la porte latine": "temporal/7/0",
  "saint jean, apôtre et évangéliste": "temporal/1/0",
  "saint jean-baptiste de la salle, confesseur": "temporal/7/0",
  "saint justin, martyr": "temporal/7/0",
  "saint sylvestre, pape et confesseur": "temporal/1/0",
  "saint thomas de cantorbéry, évêque et martyr": "temporal/1/0",
  "saint venant, martyr": "temporal/5/18",
  "saint étienne, premier martyr": "temporal/1/0",
  "sainte élisabeth de portugal, reine": "temporal/7/0",
  "saints innocents, martyrs": "temporal/1/0",
  "saints marcellin et pierre, martyrs": "temporal/7/0",
  "saints nom de jésus": "temporal/1/9",
  ...
  "samedi de la 5e semaine du carême": "temporal/6/1",
  ...
  "samedi des quatre-temps d'été": "temporal/9/22",
  "samedi des quatre-temps de carême": "temporal/5/10",
  "samedi des quatre-temps de l'avent": "temporal/0/5",
  "samedi des quatre-temps de pentecôte": "temporal/8/9",
  "samedi des quatre-temps de septembre": "temporal/9/22",
  "samedi des quatre-temps du carême": "temporal/5/10",
  "samedi saint": "temporal/6/13",
  "ss. innocents, martyrs": "temporal/1/0",
  "ss. marcellin, pierre et érasme, martyrs": "temporal/7/0",
